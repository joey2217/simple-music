...
interface AppContextProps {
  confirm: (config: Omit<DialogContentData, "resolve" | "reject" | "open">) => Promise<unknown>;
}
...
export const AppProvider: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  return (
    ...
    >
      {children}
      <AlertDialog open={dialogConfig.open} onOpenChange={(open) => setDialogConfig((c) => ({ ...c, open }))}>
        <AlertDialogContent>
          <AlertDialogHeader>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel onClick={dialogConfig.reject}>取 消</AlertDialogCancel>
            <AlertDialogAction onClick={dialogConfig.resolve}>确 定</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
    </AppContext.Provider>
